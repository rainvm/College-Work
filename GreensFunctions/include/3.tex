    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            \begin{axis}[axis lines = middle,
                ...
                xtick = {0},
                ytick= {0}]
                \addplot [mark=none] coordinates {(-1/1, 0)(-1/1, 1^2)};
                \addplot[mark=none] coordinates {(-1/1, 1^2)(0,1^2)};
                \addplot [mark=none] coordinates {(1/1, 0)(1/1, -1^2)};
                \addplot[mark=none] coordinates {(1/1, -1^2)(0,-1^2)};
                \node at (axis cs:-0.7, 1.7) {$k=1$};
                \addplot [mark=none] coordinates {(-1/2, 0)(-1/2, 2^2)};
                \addplot[mark=none] coordinates {(-1/2, 2^2)(0,2^2)};
                \addplot [mark=none] coordinates {(1/2, 0)(1/2, -2^2)};
                \addplot[mark=none] coordinates {(1/2, -2^2)(0,-2^2)};
                \node at (axis cs:-.45, 5) {$k=2$};
                \addplot [mark=none] coordinates {(-1/4, 0)(-1/4, 4^2)};
                \addplot[mark=none] coordinates {(-1/4, 4^2)(0,4^2)};
                \addplot [mark=none] coordinates {(1/4, 0)(1/4, -4^2)};
                \addplot[mark=none] coordinates {(1/4, -4^2)(0,-4^2)};
                \node at (axis cs:-0.4, 14) {$k=4$};
            \end{axis}
        \end{tikzpicture}
        \caption{Delta sequence, eq \ref{ex:ds1}}
    \end{figure}
