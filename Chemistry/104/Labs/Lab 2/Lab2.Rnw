...
\begin{document}
    ...
    \section*{Calculations}
      ...
      ggplot(cooling, aes(Time, value))+
        ...
        labs(color = "Percentage of Benzoic Acid Added", shape = "Percentage of Benzoic Acid Added")+
        ggtitle("Lauric Acid Cooling Curve")+
        theme(legend.position = c(0.78, 0.88), legend.title.align = 0.5)
      @
      \begin{table}[h]
        \centering
